        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto mt-24 text-center">
            <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-2xl p-8 sm:p-12">
              ...
              <Link
                to="/book-demo"
                className="inline-flex items-center px-8 py-3 border-2 border-blue-600 text-lg font-medium rounded-lg text-blue-600 bg-white hover:bg-blue-50 hover:border-blue-700 hover:text-blue-700 transition-all duration-300"
              >
                Book a Demo
          ...
          <div className="relative bg-white rounded-2xl p-8 max-w-lg mx-4 animate-fade-in-up">
            ...
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Not sure if CleanAgent.AI is right for you?
              </h3>
            ...
            <p className="text-sm text-gray-500 text-center mt-6">
              No pressure, no commitments. Just see how we can help.
            </p>
          </div>
        </div>
      )}

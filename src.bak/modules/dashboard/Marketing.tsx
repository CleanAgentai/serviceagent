...
import { RefreshCcw, MessageSquare, Plus, Search, Filter, ChevronDown, TrendingUp, TrendingDown, MoreHorizontal, Edit2, Trash2, DollarSign, Users, Facebook, Twitter, Instagram, Linkedin, MoreVertical } from 'lucide-react';
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <MetricCard
            ...
            value="0"
            change="+2 this month"
            icon={<TrendingUp className="h-5 w-5 ml-2" />}
          />
          <MetricCard
            title="Total Budget"
            value="$0"
            change="+5% from last month"
            icon={<DollarSign className="h-5 w-5 ml-2" />}
          />
          <MetricCard
            title="Leads Generated"
            value="0"
            change="NaN% conversion"
        ...
        <div className="bg-white rounded-xl shadow-sm">
          <div className="p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Social Media Performance</h2>
                <p className="text-sm text-gray-600">Track engagement across platforms</p>
              </div>
              <div className="flex items-center space-x-4">

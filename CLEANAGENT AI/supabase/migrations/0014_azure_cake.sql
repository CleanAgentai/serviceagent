/*
  # Add dashboard metrics and activities tables

  1. New Tables
    - dashboard_metrics
      - Stores user metrics like job counts, candidate counts, etc.
    - activities
      - Tracks user activities and notifications
  
  2. Functions
    - initialize_dashboard_metrics: Sets up initial metrics for a user
    - update_jobs_metric: Updates job counts when jobs table changes
*/
...
-- Create jobs metric update function

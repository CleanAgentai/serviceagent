...
const MessagingIntegrations = React.lazy(() => import('@/modules/dashboard/integrations/MessagingIntegrations'));
            ...
            <React.Suspense fallback={<LoadingState variant="full" message="Loading page..." />}>
              <Routes>
                ...
                >
                  ...
                  <Route path="integrations/messaging" element={<MessagingIntegrations />} />

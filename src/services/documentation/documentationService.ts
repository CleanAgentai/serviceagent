...
class DocumentationService {
  ...
  private initializeContent() {
    ...
    this.addTooltip({
      ...
      content:
        'Click here to see AI-powered recommendations for optimizing your marketing campaigns.',
    });

    this.addTooltip({
      id: 'job-posting-preview',
      content:
        'Preview how your job posting will appear on different platforms before publishing.',
    });
    ...
    this.addDocumentationSection({
      ...
      subsections: [
        ...
        },
        {
          ...
          content:
            'Understanding your campaign metrics and performance indicators...',
        },
      ],
    });
    ...
    this.setOnboardingSteps([
      {
        ...
        content:
          'Welcome to ServiceAgent.ai! This quick tour will help you get familiar with the key features.',
        icon: 'wave',
      },
      {
        id: 'marketing',
        ...
        content:
          'Discover how our AI can help automate your marketing campaigns and improve engagement.',
        icon: 'megaphone',
      },
      {
        id: 'hiring',
        ...
        content:
          'See how our AI can help you find and evaluate the best candidates faster.',
        icon: 'users',
      },
      {
        id: 'complete',
        ...
        content:
          "Congratulations! You're now ready to start using ServiceAgent.ai to its full potential.",
        icon: 'check',
      },
    ]);
  }

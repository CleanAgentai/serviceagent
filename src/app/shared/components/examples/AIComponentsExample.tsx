  ...
  const [sampleInsights, setSampleInsights] = useState([
    {
      ...
      description:
        "Several high-value customers haven't engaged with your platform in the last 30 days. Consider sending a personalized re-engagement email.",
      category: 'Engagement',
    ...
    },
    {
      ...
      description:
        'Your blog post "10 Tips for Better Productivity" is performing 45% better than average. Consider creating more content on this topic.',
      category: 'Content',
    ...
    },
    {
      ...
      description:
        'Based on usage patterns, 15 users on the free plan are approaching their limits. They may be good candidates for an upgrade to the premium plan.',
      category: 'Revenue',
      priority: 'medium' as const,
      actionable: true,
      action: {
  ...
  const [aiFeatures, setAiFeatures] = useState([
    {
      ...
      description:
        'Automatically generate replies to common customer inquiries based on your previous responses and knowledge base.',
      enabled: true,
    ...
    },
    {
      ...
      description:
        'Receive AI-powered suggestions for blog posts, social media content, and marketing materials.',
      enabled: false,
      category: 'Content',
    },
    {
      ...
      description:
        'Automatically generate summaries of your meetings with action items and key points.',
      enabled: true,
    ...
    },
    {
      ...
      name: 'Data Insights',
      description:
        'Get AI-powered insights from your business data to identify trends and opportunities.',
      enabled: true,
      category: 'Analytics',
    },
    {
      ...
      description:
        'Draft professional emails based on brief descriptions of what you want to communicate.',
      enabled: false,
    ...
    },
    {
      ...
      description:
        'AI will analyze your calendar and suggest optimal meeting times and productivity blocks.',
      enabled: false,
      requiresPremium: true,
      category: 'Productivity',
    },
...
The CleanAgent Team`,
  ...
  const handleInsightFeedback = (insightId: string, isHelpful: boolean) => {
    console.log(
      `Insight ${insightId} marked as ${isHelpful ? 'helpful' : 'not helpful'}`,
    );
    ...
    return [
      {
        ...
        description:
          'Based on recent search patterns, there appears to be growing interest in your services from the healthcare sector.',
        category: 'Growth',
        priority: 'high' as const,
      },
      {
        ...
        description:
          'Your team is spending 30% more time on administrative tasks compared to similar organizations. Consider implementing automation.',
        category: 'Operations',
        priority: 'medium' as const,
        actionable: true,
        action: {
    ...
    <div className="space-y-8 max-w-4xl mx-auto p-6">
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The AIInsightsPanel component displays AI-generated insights based on
          your data. It supports loading states, error handling, and user
          feedback.
        </p>
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The AIAutomationSettings component allows users to control which AI
          features are enabled. It supports grouping by category, premium
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          The AIEditableContent component displays AI-generated content that
          users can edit, regenerate, or accept. It supports version history and
          copy functionality.
        </p>
        ...
        <AIEditableContent
          ...
          onAccept={(content) =>
            alert('Email content accepted and ready to send')
          }
      ...
      <section>
        ...
        <p className="text-gray-600 mb-4">
          This example shows how all three AI components can work together in a
          real-world scenario.
        </p>
        ...
        >
          <div className="space-y-6">
                  ...
                  insights={[
                    {
                      ...
                      description:
                        'This customer has logged in 5 times in the past week and used the reporting feature extensively.',
                      category: 'Usage',
                    },
                    {
                      id: 'c2',
                      ...
                      description:
                        'Based on usage patterns, this customer is a good candidate for the Premium plan.',
                      priority: 'medium' as const,
                      actionable: true,
                      action: {
            ...
            <AIAutomationSettings
              ...
              features={[
                {
                  ...
                  description:
                    'Send AI-generated follow-up emails after customer interactions',
                  enabled: true,
                  category: 'Emails',
                },
                {
                  ...
                  description:
                    'Analyze customer sentiment in emails and provide response suggestions',
                  enabled: true,
                  category: 'Analysis',
                },
                {
                  ...
                  description:
                    'Use customer history and preferences for highly personalized communications',
                  enabled: false,
                  requiresPremium: true,
                  category: 'Emails',
                },
              ...
              onChange={(id, enabled) =>
                console.log(`Setting ${id} to ${enabled}`)
              }
              isPremium={false}
            />
          </div>

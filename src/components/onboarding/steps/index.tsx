    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Configure your marketing channels and analytics preferences
          </p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Set up your hiring process and preferences
          </p>
        </div>
      </div>
...
export const CompleteStep: React.FC = () => {
  return (
    <div className="text-center">
      ...
      <p className="text-gray-600">
        You're all set to start using CleanAgent. We've configured your
        preferences and you can always adjust them later in the settings.
      </p>
      <div className="mt-6">

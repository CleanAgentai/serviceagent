    ...
    description: (
      <>
        ...
        <p>
          ...
          <a href="https://calendly.com/serviceagent/25min">
      ...
      {!selectedPlan && (
        <>
          <div className="flex justify-center items-center mb-20">
            <span
              className={`mr-4 font-medium transition-all duration-300 ${isYearly ? 'text-slate-900' : 'text-slate-600'}`}
            >
              Yearly (Save 20%)
            </span>
            ...
            >
              <div className="relative bg-gradient-to-br from-card to-teal/5 rounded-3xl p-8 border border-teal/20 shadow-xl hover:shadow-3xl hover:-translate-y-3 hover:border-teal/40 transition-all duration-500 h-full flex flex-col">
                ...
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-primary group-hover:text-teal transition-colors duration-300 mb-2">
                    {plans[0].title} Plan
                  </h3>
            ...
            >
              <div className="relative bg-gradient-to-br from-card to-gold/5 rounded-3xl p-8 border-2 border-gold/40 shadow-3xl hover:shadow-[0_25px_80px_-12px_rgba(0,0,0,0.25)] lg:scale-105 hover:-translate-y-4 hover:border-gold/60 transition-all duration-300 h-full flex flex-col transform">
                ...
                <div className="text-center mb-8 pt-4">
                  ...
                  <h3 className="text-2xl font-bold text-primary group-hover:text-gold transition-colors duration-300 mb-2">
                    {plans[1].title} Plan
                  </h3>
                  <p className="text-muted-foreground text-sm mb-4">
                    {plans[1].description}
          ...
          <div className="text-center mt-12 max-w-2xl mx-auto">
            <p className="text-sm text-slate-600">
              All plans include all features during your trial. You can change

        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="text-white">
            ...
            <p className="mt-2 text-blue-100">
              Set up a new AI-powered interview session
            </p>
          </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className="w-full text-left p-3 text-sm text-blue-700 hover:bg-blue-100/50 rounded-lg transition-colors"
                      >
                        What are your career goals and how does this position
                        align with them?
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-0.5">
                            Provide immediate feedback during the interview
                          </p>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-0.5">
                            Analyze candidate's emotional responses
                          </p>
                        </div>
                        <div className="relative inline-block w-12 align-middle select-none">
                          <input

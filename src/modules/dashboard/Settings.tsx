                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500">
                          Recommended: Square JPG, PNG, or SVG. Max size 2MB.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <input
                            type="text"
                            className="block flex-1 px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow"
                            placeholder="#3B82F6"
                          />
                        </div>
                      </div>

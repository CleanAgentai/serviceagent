...
const MetricCard: React.FC<MetricCardProps> = ({ title, value, subValue, icon }) => (
  <div className="bg-white rounded-lg p-4 shadow-sm">
    ...
    <div className="flex items-baseline">
      ...
      <p className="ml-2 text-sm text-green-500">{subValue}</p>
    </div>
  </div>
);
...
export default function Launchpad() {
  ...
  return (
    <div className="h-[calc(100vh-2rem)] space-y-4">
      {/* Header */}
      <div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-xs text-gray-400">Try different filters or start using our AI agents to see your activity</p>
          <button 

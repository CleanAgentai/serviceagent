    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a Regional Plumbing Company Cut Hiring Time by 73% and Hired 5
          Technicians in Just 2 Weeks
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          By automating resume screening, interviews, and scoring, this plumbing
          company filled every open role in 14 days, eliminated no-shows, and
          turned chaotic hiring into a system.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A regional plumbing company was struggling to hire qualified
          technicians during a period of rapid growth. They needed 5 new
          plumbers quickly but traditional hiring methods were too slow and
          unreliable.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they filled all 5 roles in just 14
          days, reduced their time-to-hire by 73%, and eliminated interview
          no-shows completely.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          They needed a{' '}
          <span className="font-bold">faster, more reliable way</span> to
          identify and hire qualified plumbing technicians.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ServiceAgent was implemented with custom screening for plumbing
          technician roles:
        </p>
        <ul className={bullet}>
        ...
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "We were spending way too much time on hiring and still not getting
          the right people. ServiceAgent changed everything. Now we get
          qualified candidates ready for final interviews in minutes, not days."
          <br />
        ...
        <p className="mb-2 text-slate-800">
          For plumbing companies, hiring qualified technicians quickly is
          essential for meeting customer demand and maintaining service quality.
          ServiceAgent provided this company with an efficient solution that
          accelerated their hiring process while dramatically reducing

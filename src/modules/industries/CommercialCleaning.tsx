    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a Commercial Cleaning Company Reduced No-Shows by 100% and Filled
          9 Roles in 14 Days
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          By automating candidate screening and interviews with ServiceAgent,
          this growing commercial cleaning business eliminated interview
          no-shows, cut time-to-hire from 10 days to under 3, and fully staffed
          a new facility in just two weeks.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A rapidly expanding commercial cleaning company was struggling with
          hiring delays and interview no-shows. They needed to staff a new
          facility quickly but traditional hiring methods were too slow and
          unreliable.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they filled all 9 open roles in just
          14 days, eliminated interview no-shows completely, and reduced their
          time-to-hire by 70%.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ...
          that could scale with their growth.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
          The ServiceAgent Implementation
        </span>
        <p className="mb-2 text-slate-800">
          ServiceAgent was deployed with custom screening for commercial
          cleaning roles:
        </p>
        <ul className={bullet}>
        ...
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "The no-show problem was killing us. We'd schedule 10 interviews and
          only 6 would show up. With ServiceAgent, every qualified candidate
          shows up for their final interview. It's like night and day."
          <br />
        ...
        <p className="mb-2 text-slate-800">
          For commercial cleaning companies, reliable hiring is essential for
          meeting client commitments and maintaining service quality.
          ServiceAgent provided this company with a solution that not only
          accelerated their hiring process but also eliminated the costly
          problem of interview no-shows.
        </p>
      </div>
    </div>
  );

    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a Multi-Location Franchise Reduced Hiring Chaos and Standardized
          Recruiting Across 14 Units in 21 Days
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          This fast-growing franchise used ServiceAgent to centralize and
          automate its entire recruiting process—cutting hiring time by 68%,
          boosting hire quality, and freeing up managers to focus on operations
          instead of resumes.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A rapidly expanding franchise with 14 locations was struggling to
          maintain consistent hiring standards across all units. Each location
          was handling recruitment independently, leading to chaos and
          inconsistent results.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they standardized their entire
          recruiting process, reduced hiring time by 68%, and improved hire
        ...
        <p className="mb-2 text-slate-800">
          They needed a{' '}
          <span className="font-bold">centralized, standardized way</span> to
          handle recruitment across all locations.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ServiceAgent was implemented across all 14 locations with standardized
          screening:
        </p>
        <ul className={bullet}>
          ...
          <tbody>
            ...
            <tr>
              <td className={tdClass}>
                <strong>Total (14 locations)</strong>
              </td>
              <td className={tdClass}>
                <strong>89</strong>
              </td>
              <td className={tdClass}>
                <strong>238 hours</strong>
              </td>
              <td className={tdClass}>
        ...
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "Before ServiceAgent, each location was doing their own thing. Now we
          have a consistent, professional hiring process across all 14
          locations. The quality of hires has improved dramatically."
          <br />
          <span className="block mt-2 text-right font-semibold">
            — Michael Thompson, Franchise Owner
          </span>
        </blockquote>
        <span className="text-blue-700 font-semibold underline mb-2 block">
          Key Achievements
        ...
        <p className="mb-2 text-slate-800">
          For multi-location franchises, consistent hiring processes are crucial
          for maintaining brand standards and operational efficiency.
          ServiceAgent provided this franchise with a centralized solution that
          standardized recruitment while dramatically reducing administrative

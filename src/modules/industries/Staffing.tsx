    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a 15-Person Staffing Team Used ServiceAgent to Increase Fill Rates
          and Save 280+ Hours a Month
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          By automating their hiring process with ServiceAgent, this staffing
          team increased fill rates, reduced admin time, and improved candidate
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A regional light industrial staffing firm with 15 recruiters was
          struggling to keep up with high applicant volume for entry-level
          warehouse and logistics roles. Applications were strong, but their
          internal team couldn't screen fast enough—causing drop-off, missed
          placements, and recruiter burnout.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they increased fill rates by 40%,
          saved over 280 hours of admin time monthly, and improved candidate
        ...
        <p className="mb-2 text-slate-800">
          They needed a{' '}
          <span className="font-bold">faster, more efficient way</span> to
        ...
        <p className="mb-2 text-slate-800">
          ServiceAgent was implemented to automate the initial screening
          process:
        </p>
        <ul className={bullet}>
        ...
        <table className={tableClass}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className={tdClass}>
                <strong>$23,721</strong>
              </td>
            </tr>
          </tbody>
        </table>
        <span className="text-blue-700 font-semibold underline mb-2 block">
          Recruiting Manager Feedback
        </span>
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "Our recruiters were drowning in applications and spending hours on
          phone screens. ServiceAgent eliminated all of that. Now they focus on
          building relationships with pre-qualified candidates. Our fill rates
          have never been higher."
          <br />
          <span className="block mt-2 text-right font-semibold">
            — Sarah Williams, Recruiting Manager
          </span>
        </blockquote>
        <span className="text-blue-700 font-semibold underline mb-2 block">
          Key Achievements
        ...
        <p className="mb-2 text-slate-800">
          For staffing companies, efficient candidate screening is crucial for
          maintaining high fill rates and recruiter productivity. ServiceAgent
          provided this company with an automated solution that dramatically
          improved their operational efficiency while enhancing candidate
          quality.
        </p>
      </div>
    </div>

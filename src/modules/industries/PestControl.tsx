    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a Regional Pest Control Company Slashed Time-to-Hire by 73% and
          Reduced Turnover with AI Screening
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          By automating their hiring process with ServiceAgent, this pest
          control company filled 9 technician roles in under two weeks—while
          improving quality and reducing burnout across the team.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A regional pest control company was struggling with high turnover and
          slow hiring processes. They needed 9 new technicians quickly but
          traditional hiring methods were too slow and resulted in poor
          retention.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they filled all 9 roles in just 14
          days, reduced their time-to-hire by 73%, and significantly improved
          employee retention.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ...
          identify and hire reliable pest control technicians.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ServiceAgent was implemented with custom screening for pest control
          technician roles:
        </p>
        <ul className={bullet}>
        ...
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "The turnover was killing us. We'd hire someone and they'd quit within
          a month. ServiceAgent helped us identify candidates who are actually
          committed to the work. Our retention has never been better."
          <br />
        ...
        <p className="mb-2 text-slate-800">
          For pest control companies, hiring reliable technicians who stay with
          the company is crucial for maintaining service quality and
          profitability. ServiceAgent provided this company with an efficient
          solution that not only accelerated their hiring process but also

    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
          How a Fast-Growing HVAC Business Hired 7 Techs in 21 Days Without a
          Single Resume Review
        </h1>
        <p className="text-lg text-slate-700 mb-6">
          Using ServiceAgent to automate applicant screening, this HVAC company
          filled 7 technician roles in under 3 weeks, reduced time-to-hire by
          68%, and freed up over 45 hours of admin time—all during peak season.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <p className="mb-2 text-slate-800">
          A rapidly expanding HVAC company was struggling to hire qualified
          technicians during peak season. They needed 7 new techs quickly but
          traditional hiring methods were too slow and inefficient.
        </p>
        <p className="mb-2 text-slate-800">
          After implementing ServiceAgent, they filled all 7 roles in just 21
          days, eliminated manual resume screening, and reduced their
          time-to-hire by 68%.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ...
          identify and hire qualified HVAC technicians.
        </p>
        <hr className="my-8 border-blue-200" />
        <span className="text-blue-700 font-semibold underline mb-2 block">
        ...
        <p className="mb-2 text-slate-800">
          ServiceAgent was implemented with custom screening for HVAC technician
          roles:
        </p>
        <ul className={bullet}>
        ...
        <blockquote className="italic text-slate-700 border-l-4 border-blue-300 pl-4 my-4">
          "We were drowning in resumes and spending hours on phone screens.
          ServiceAgent eliminated all of that. Now we get pre-qualified
          candidates ready for final interviews. It's a game-changer for our
          hiring process."
          <br />
        ...
        <p className="mb-2 text-slate-800">
          For HVAC companies, hiring qualified technicians quickly is crucial
          for meeting customer demand and maintaining service quality.

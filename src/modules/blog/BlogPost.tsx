...
const post: BlogPost = {
  ...
  author: {
    ...
    bio: "Founder & CEO at ServiceAgent.AI. Serial entrepreneur with a passion for AI and business automation.",
  },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content={`${post.title} - ServiceAgent Blog`}
        />
        <meta property="og:description" content={post.excerpt} />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content={`https://cleanagent.ai/blog/${post.slug}`}
        />
        <meta
          property="og:image"
          content={`https://cleanagent.ai${post.image}`}
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content={`${post.title} - CleanAgent Blog`}
        />

...
export const Blog = () => {
  ...
  const structuredData = {
    ...
    description:
      'AI hiring insights, product updates, and case studies for service businesses',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="AI hiring, automated interviews, service industry recruitment, hiring technology, candidate scoring"
        />
        <meta
          property="og:title"
          content="Blog | ServiceAgent – AI Hiring Insights & Resources"
        />
        <meta
      ...
      <div className="min-h-screen mt-16 bg-background">
        ...
        <section className="relative py-20 overflow-hidden bg-gradient-to-br from-background via-primary/5 to-muted/30">
          ...
          <div className="absolute inset-0">
            ...
            <div
              className="absolute bottom-20 right-1/4 w-80 h-80 bg-gradient-to-br from-gold/10 to-transparent rounded-full blur-3xl animate-pulse"
              style={{ animationDelay: '1s' }}
            />
            <div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-teal/5 to-transparent rounded-full blur-3xl animate-pulse"
              style={{ animationDelay: '2s' }}
            />

            {/* Floating particles */}
            <div
              className="absolute top-32 left-16 w-2 h-2 bg-primary/30 rounded-full animate-bounce"
              style={{ animationDelay: '0.5s' }}
            />
            <div
              className="absolute top-40 right-20 w-1 h-1 bg-gold/40 rounded-full animate-bounce"
              style={{ animationDelay: '1.2s' }}
            />
            <div
              className="absolute bottom-32 left-32 w-1.5 h-1.5 bg-teal/30 rounded-full animate-bounce"
              style={{ animationDelay: '0.8s' }}
            />
            <div
              className="absolute bottom-48 right-16 w-2 h-2 bg-terracotta/20 rounded-full animate-bounce"
          ...
          <div className="container mx-auto px-6 relative">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              >
                <Badge
                  variant="outline"
                  className="px-6 py-2 text-sm font-medium border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 transition-all duration-300"
                >
              ...
              >
                Discover insights, tips, and case studies to help service
                businesses
              </motion.p>
            </div>
          </div>
              ...
              <div className="container mx-auto px-6">
                <div className="max-w-6xl mx-auto">
                  ...
                  >
                    <Badge
                      variant="secondary"
                      className="mb-6 bg-gradient-to-r from-primary/10 to-gold/10 border-primary/30 text-primary font-semibold px-4 py-2"
                    >
                        ...
                        <CardHeader className="p-0">
                          <div className="relative overflow-hidden rounded-t-lg">
                            ...
                            <div className="absolute top-4 left-4">
                              <Badge
                                variant="secondary"
                                className="bg-background/90 backdrop-blur-sm border-primary/20 text-primary font-medium"
                              >
                                {post.category}
                              </Badge>
                            </div>

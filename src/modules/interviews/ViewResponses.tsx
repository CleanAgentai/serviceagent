      ...
      try {
        ...
        if (error) {
          ...
          setResponses([
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Strong technical skills and good communication. Shows potential for senior roles.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Excellent product vision and leadership qualities. Good fit for the role.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Creative approach to user-centered design with a strong portfolio. Demonstrates excellent understanding of design systems.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Strategic thinker with a data-driven approach to marketing. Excellent leadership potential.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Highly analytical with strong statistical background. Excellent understanding of machine learning algorithms.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Strong technical background with excellent understanding of CI/CD pipelines and cloud infrastructure.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Excellent communication skills and customer-focused approach. Strong problem-solving abilities.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Well-organized with strong stakeholder management skills. Good understanding of agile methodologies.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Strong technical skills with excellent understanding of backend architecture. Good problem-solving abilities.",
                strengths: [
            ...
            },
            {
              ...
              aiAnalysis: {
                keyObservations:
                  "Strategic approach to HR with focus on employee development. Strong understanding of HR policies and procedures.",
                strengths: [
          ...
          const formattedResponses = data.map((item) => {
            const interview = Array.isArray(item.interviews)
              ? item.interviews[0]
              : item.interviews;
            return {
              id: item.id,
          ...
          <Card key={response.id} className="p-4">
            <div className="grid grid-cols-5 gap-4 items-center">
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant={
                    response.status === "completed" ? "outline" : "secondary"
                  }
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold">
                AI Analysis: {selectedResponse.candidateName}
              </h2>
              <button
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <Card className="p-4 bg-blue-50">
                    ...
                    <p className="mt-2 text-sm text-blue-800">
                      {selectedResponse.overallRating >= 9
                        ? "Exceptional candidate highly recommended for the role."
                        : selectedResponse.overallRating >= 8
                        ? "Strong candidate well-suited for the position."
                        : selectedResponse.overallRating >= 7
                        ? "Good candidate with relevant qualifications."
                ...
                <div>
                  ...
                  <Card className="p-4 bg-blue-50">
                    <p className="mb-4 text-blue-800">
                      {selectedResponse.aiAnalysis.keyObservations}
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      <div>
                        ...
                        <ul className="space-y-1">
                          {selectedResponse.aiAnalysis.strengths.map(
                            (strength, index) => (
                              <li
                                key={index}
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          {selectedResponse.aiAnalysis.weaknesses.map(
                            (weakness, index) => (
                              <li
                                key={index}
                                className="flex items-start gap-2 text-blue-800"
              ...
              <div className="pt-4 flex gap-2">
                ...
                <Button
                  onClick={() =>
                    navigate(`/interviews/responses/${selectedResponse.id}`)
                  }
                  className="w-full"
                >

  ...
  React.useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        'content',
        'ServiceAgent AI Privacy Policy - Learn about how we protect and handle your data.',
      );
    }
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <article className="prose prose-lg max-w-none bg-white rounded-xl shadow-sm p-8 sm:p-12">
          ...
          <p className="lead">
            Welcome to ServiceAgent, a service provided by CleanAgent, LLC
          ...
          <p>
            ...
            (https://www.fsagent.com) (the "Website") and use our services
          ...
          <ul>
            <li>
              ...
              Services, we collect personal details such as your name, email
              address, phone number, company name, and payment details.
            </li>
            <li>
              <strong>Communications:</strong> If you contact us, we may collect
              information such as your name, email address, and any other
              details you provide.
            </li>
            <li>
              <strong>Content You Submit:</strong> If you provide feedback,
              testimonials, or other content, we may collect this information.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              beacons, and similar technologies to enhance user experience and
          ...
          <p>
            We may receive data from third-party service providers, business
          ...
          <ul>
            <li>
              ...
              information with third-party vendors who help us operate our
              business (e.g., payment processors, hosting providers, analytics
              services).
            </li>
            <li>
              <strong>For Legal Compliance:</strong> We may disclose information
              to comply with legal obligations, protect our rights, or respond
              to legal requests.
            </li>
            <li>
            ...
            <li>
              ...
              third parties when we have your explicit consent.
            </li>
          </ul>
          ...
          <p>
            ...
            unauthorized access, loss, misuse, or alteration. However, no data
            transmission or storage can be guaranteed 100% secure. If you
          ...
          <ul>
            ...
            <li>
              <strong>Opt-Out:</strong> You can opt out of marketing emails by
              following the unsubscribe link.
            </li>
            <li>
              <strong>Cookies:</strong> You can manage cookie preferences
              through your browser settings.
            </li>
          </ul>
          <p>
            To exercise these rights, please contact us at
            support@serviceagent.ai.
          </p>
          ...
          <p>
            ...
            and processed in the U.S. By using our Services, you consent to this
            transfer.
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mt-8">
            ...
            <address className="not-italic">
              ...
              <p>
                Email: <a href="mailto:admin@fsagent.com">admin@fsagent.com</a>
              </p>
              <p>
                Phone: <a href="tel:+18137505308">813-750-5308</a>
              </p>
            </address>
          </div>
        </article>

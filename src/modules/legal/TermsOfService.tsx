  ...
  React.useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        'content',
        'ServiceAgent AI Terms of Service - Read about our terms and conditions for using our services.',
      );
    }
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <article className="prose prose-lg max-w-none bg-white rounded-xl shadow-sm p-8 sm:p-12">
          ...
          <p className="lead">
            ...
            (https://www.fsagent.com) and services (collectively, the
          ...
          <p>
            ...
            and agreed to these Terms, as well as our Privacy Policy. If you are
          ...
          <ul>
            ...
            <li>
              Use bots, scripts, or automated methods to access our Services.
            </li>
          </ul>
          ...
          <p>
            All content, logos, and trademarks on our Services are owned by
            ServiceAgent, LLC or its licensors. You may not copy, reproduce, or
          ...
          <p>
            ...
            violate these Terms or engage in activities that may harm our
            Services or users. You may terminate your account at any time by
          ...
          <p>
            ...
            warranties of any kind. We do not guarantee that our Services will
            be error-free or uninterrupted. We are not responsible for any loss
            resulting from reliance on our Services.
          </p>
          ...
          <ul>
            <li>
              ServiceAgent, LLC shall not be liable for any indirect,
              incidental, or consequential damages arising from your use of our
              Services.
            </li>
            <li>
              Our total liability in any claim related to the Services shall not
          ...
          <p>
            You agree to indemnify and hold ServiceAgent, LLC harmless from any
            claims, liabilities, damages, or expenses arising from your use of
          ...
          <p>
            ...
            Florida, except for claims that may qualify for small claims court.
          </p>
          ...
          <p>
            ...
            use of our Services after changes constitute acceptance of the
            revised Terms.
          </p>

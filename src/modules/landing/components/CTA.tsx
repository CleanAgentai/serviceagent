...
const CTA = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-background via-muted/20 to-card/30 overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-0 w-80 h-80 bg-teal/4 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: '2s' }}
      />
      <div
        className="absolute top-1/2 left-1/3 w-64 h-64 bg-terracotta/3 rounded-full blur-3xl animate-pulse"

...
const IndustryExpertise = () => {
  ...
  const industryData: Gallery4Item[] = [
    {
      ...
      description:
        'Find reliable house cleaners with AI screening that tests attention to detail, trustworthiness, and customer service skills for home environments.',
    ...
    },
    {
      ...
      description:
        'Hire commercial cleaning staff with AI interviews that assess reliability, attention to detail, and ability to work in office and retail environments.',
      href: '/industries/CommercialCleaning',
      image:
        'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    },
    {
      id: 'hvac',
      title: 'HVAC Services',
      description:
        'Screen HVAC technicians with technical assessments and safety protocols. AI evaluates problem-solving skills and customer communication abilities.',
    ...
    },
    {
      ...
      description:
        'Find skilled plumbers through AI screening that tests technical knowledge, problem-solving abilities, and customer service in emergency situations.',
      href: '/industries/Plumbing',
      image:
        'https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    },
    {
      id: 'landscaping',
      title: 'Landscaping & Lawn Care',
      description:
        'Hire landscaping crews with AI interviews that assess outdoor work experience, equipment knowledge, and seasonal availability patterns.',
    ...
    },
    {
      ...
      title: 'Pest Control',
      description:
        'Screen pest control technicians for safety compliance, chemical handling knowledge, and customer education skills through specialized AI assessments.',
      href: '/industries/PestControl',
      image:
        'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    },
    {
      id: 'franchises',
      title: 'Franchises',
      description:
        'Scale hiring across multiple franchise locations with consistent AI screening that maintains brand standards and service quality across all units.',
    ...
    },
    {
      ...
      description:
        'Accelerate candidate screening for staffing agencies with AI interviews that pre-qualify candidates for multiple client requirements and roles.',
    ...
    },
    {
      ...
      description:
        'Hire restaurant staff with AI interviews that test food safety knowledge, customer service skills, and ability to work in fast-paced environments.',
    ...
    },
    {
      ...
      description:
        'Find hospitality staff through AI screening that evaluates guest service excellence, cultural sensitivity, and ability to handle high-stress situations.',
  ...
  return (
    <section
      id="industries"
      className="py-24 bg-gradient-to-b from-card/20 to-background relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ServiceAgent specializes in high-turnover service industries where
            quality hiring makes the difference between success and struggle.
          </p>
        </div>
          ...
          >
            <div className="relative bg-gradient-to-br from-card to-gold/5 rounded-3xl overflow-hidden border border-gold/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-gold/40 transition-all duration-500">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  to="/industries/residential-cleaning"
                  className="block hover:underline group-hover:text-gold transition-colors duration-300"
                >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Find reliable house and commercial cleaners with AI screening
                  that tests attention to detail, trustworthiness, and customer
                  service skills.
                </p>
            ...
            <div className="relative bg-gradient-to-br from-card to-teal/5 rounded-3xl overflow-hidden border border-teal/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-teal/40 transition-all duration-500">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  ...
                  className="block hover:underline group-hover:text-teal transition-colors duration-300"
                >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Hire restaurant staff with AI interviews that test food safety
                  knowledge, customer service skills, and ability to work under
                  pressure.
                </p>
                <div className="flex items-center justify-between pt-2">
          ...
          >
            <div className="relative bg-gradient-to-br from-card to-terracotta/5 rounded-3xl overflow-hidden border border-terracotta/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-terracotta/40 transition-all duration-500">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  to="/industries/hvac"
                  className="block hover:underline group-hover:text-terracotta transition-colors duration-300"
                >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Screen HVAC technicians with technical assessments and safety
                  protocols. AI evaluates problem-solving skills and customer
                  communication.
                </p>
                <div className="flex items-center justify-between pt-2">
          ...
          >
            <div className="relative bg-gradient-to-br from-card to-gold/5 rounded-3xl overflow-hidden border border-accent/20 shadow-xl hover:shadow-3xl hover:-translate-y-3 hover:border-accent/40 transition-all duration-500">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  to="/industries/staffing"
                  className="inline-block hover:underline group-hover:text-accent transition-colors duration-300"
                >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Accelerate candidate screening for staffing agencies with AI
                  interviews that pre-qualify candidates for multiple client
                  requirements.
                </p>
                <div className="flex items-center justify-between pt-2">
          ...
          >
            <div className="relative bg-gradient-to-br from-card to-primary/5 rounded-3xl overflow-hidden border border-primary/20 shadow-xl hover:shadow-3xl hover:-translate-y-3 hover:border-primary/40 transition-all duration-500">
              ...
              <div className="p-6 space-y-4">
                ...
                <Link
                  to="/industries/franchises"
                  className="block hover:underline group-hover:text-primary transition-colors duration-300"
                >
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Scale hiring across multiple franchise locations with
                  consistent AI screening that maintains brand standards and
                  service quality.
                </p>
                <div className="flex items-center justify-between pt-2">
              ...
              <div className="p-6 pt-4 space-y-4">
                <div className="flex items-center justify-center gap-3 group/item hover:bg-muted/20 rounded-lg p-2 transition-colors duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground">
                      CNAs, home health aides, medical assistants
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 group/item hover:bg-muted/20 rounded-lg p-2 transition-colors duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Production workers, quality control, assembly
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 group/item hover:bg-muted/20 rounded-lg p-2 transition-colors duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Warehouse workers, forklift operators, inventory
                    </div>
                  </div>
                </div>
                <div className="pt-2">

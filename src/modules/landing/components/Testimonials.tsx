...
import { Star, ChevronLeft, ChevronRight, Check, Zap, Shield } from "lucide-react";
...
const testimonials = [
  {
    ...
    quote: "We reduced hiring time from weeks to days. Candidate quality improved dramatically, and managers finally stopped screening resumes.",
  ...
  },
  {
    ...
    quote: "Every applicant gets interviewed instantly. No-shows dropped, and we only review top-ranked candidates. It's become our default hiring funnel.",
  ...
  },
  {
    ...
    quote: "ServiceAgent let us screen 100% of applicants with consistent scoring. Our team reclaimed 50+ hours per month and placements went up.",
     ...
     <div className="container mx-auto px-6 relative">
       ...
       >
         ...
         <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
           Real results from businesses that transformed their hiring process with ServiceAgent
         </p>
       </div>
       ...
       >
         ...
         <div className="flex justify-center items-center space-x-4 mt-12" role="tablist">

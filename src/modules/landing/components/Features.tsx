...
const bentoFeatures = [
  {
    ...
    description:
      'Conduct video and chat interviews automatically with AI-powered questioning tailored to each role.',
    href: '#',
    cta: 'Learn more',
    background: (
  ...
  },
  {
    ...
    description:
      'Get 1-10 candidate scores with detailed AI reasoning for every response and interaction.',
    href: '#',
    cta: 'Learn more',
    background: (
  ...
  },
  {
    ...
    description:
      'Watch back any interview at your convenience with full video playback and transcript access.',
    href: '#',
    cta: 'Learn more',
    background: (
  ...
  },
  {
    ...
    description:
      'Track hiring metrics, performance trends, and ROI with comprehensive analytics.',
    href: '#',
    cta: 'Learn more',
    background: (
  ...
  },
  {
    ...
    description:
      'Seamlessly connect with Workable, Bullhorn, BambooHR, and 20+ other popular ATS platforms.',
    href: '#',
    cta: 'Learn more',
    background: (
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Everything you need to transform your hiring process with AI-powered
            intelligence
          </p>
        </div>
              ...
              <div className="relative bg-gradient-to-br from-card to-gold/5 rounded-3xl p-8 border border-gold/20 shadow-xl hover:shadow-3xl hover:-translate-y-3 hover:border-gold/40 transition-all duration-500 max-md:mb-4">
                ...
                <div className="pt-8 space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Conduct intelligent video and chat interviews automatically
                    with AI-powered questioning tailored to each role and
                    candidate.
                  </p>
            ...
            >
              <div className="relative bg-gradient-to-br from-card to-teal/5 rounded-3xl p-8 border border-teal/20 shadow-xl hover:shadow-3xl hover:-translate-y-3 hover:border-teal/40 transition-all duration-500 max-md:mb-4">
                ...
                <div className="pt-8 space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Get comprehensive 1-10 candidate scores with detailed AI
                    reasoning for every response and interaction point.
                  </p>
            ...
            >
              <div className="relative bg-gradient-to-br from-card to-terracotta/5 rounded-3xl p-8 border border-terracotta/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-terracotta/40 transition-all duration-500">
                ...
                <div className="pt-8 space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Watch back any interview at your convenience with full video
                    playback and detailed transcript access.
                  </p>
              ...
              <div className="relative bg-gradient-to-br from-card to-accent/5 rounded-3xl p-10 border border-accent/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-accent/40 transition-all duration-500 max-md:mb-4">
                ...
                <div className="pt-8 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    Track hiring metrics, performance trends, and ROI with
            ...
            >
              <div className="relative bg-gradient-to-br from-card to-primary/5 rounded-3xl p-10 border border-primary/20 shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:border-primary/40 transition-all duration-500">
                ...
                <div className="pt-8 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    Seamlessly connect with Workable, Bullhorn, BambooHR, and
                    20+ other popular ATS platforms for unified workflow.
                  </p>
                  <div className="flex items-center gap-4">

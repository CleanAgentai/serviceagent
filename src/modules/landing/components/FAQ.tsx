...
const faqs = [
  {
    ...
    answer:
      'ServiceAgent conducts video and chat interviews automatically using AI. Candidates answer your custom questions, and our AI evaluates responses, giving each candidate a score from 1-10 with detailed reasoning.',
  },
  {
    id: 'item-2',
    question: 'Do I need an ATS?',
    answer:
      'No, ServiceAgent works standalone. However, we integrate with popular ATS platforms like Workable, Bullhorn, and BambooHR to streamline your existing workflow.',
  },
  {
    id: 'item-3',
    question: 'What roles is this best for?',
    answer:
      'ServiceAgent excels with high-turnover service roles: cleaning staff, restaurant workers, HVAC technicians, pest control specialists, landscaping crews, and franchise positions.',
  },
  {
    id: 'item-4',
    question: 'Can I customize the questions?',
    answer:
      'Absolutely! Create custom interview questions or use our industry-specific templates. You can tailor questions for each role and location.',
  },
  {
    id: 'item-5',
    question: 'How fast can I go live?',
    answer:
      'Most customers are conducting interviews within 10 minutes of setup. Our quick onboarding gets you hiring immediately.',
  },
  {
    id: 'item-6',
    question: 'What happens after the trial?',
    answer:
      'Choose a plan that fits your hiring volume. Cancel anytime with no long-term commitments. Your interview data stays accessible.',
  },
];
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get answers to common questions about ServiceAgent's AI hiring

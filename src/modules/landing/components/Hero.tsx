...
const Hero = () => {
  ...
  return (
    <section className="relative mt-16 py-16 lg:py-20 bg-gradient-to-br from-background via-card/30 to-muted/20 overflow-hidden">
      ...
      <div
        className="absolute top-0 left-0 w-[800px] h-[800px] bg-gold/3 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: '0s' }}
      />
      <div
        className="absolute top-1/2 right-0 w-[600px] h-[600px] bg-teal/4 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: '2s' }}
      />
      <div
        className="absolute bottom-0 left-1/3 w-[400px] h-[400px] bg-terracotta/3 rounded-full blur-3xl animate-pulse"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl sm:mt-10 lg:mt-0">
                ...
                <div className="group relative">
                  <div className="h-full relative bg-gradient-to-br from-card to-gold/5 border border-gold/20 rounded-2xl p-6 text-center space-y-4 hover:border-gold/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-gold/30 transition-all duration-300">
                    ...
                    <div className="space-y-1">
                      <div className="text-2xl font-bold text-primary group-hover:text-gold transition-colors duration-300">
                        5min
                      </div>
                    ...
                    <div className="flex items-center justify-center gap-1 text-gold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div
                        className="w-1 h-1 bg-gold rounded-full animate-ping"
                        style={{ animationDelay: '0s' }}
                      ></div>
                      <div
                        className="w-1 h-1 bg-gold rounded-full animate-ping"
                ...
                <div className="group relative">
                  <div className="h-full relative bg-gradient-to-br from-card to-teal/5 border border-teal/20 rounded-2xl p-6 text-center space-y-4 hover:border-teal/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-teal/30 transition-all duration-300">
                    ...
                    <div className="space-y-1">
                      <div className="text-2xl font-bold text-primary group-hover:text-teal transition-colors duration-300">
                        87%
                      </div>
                      <div className="text-sm font-medium text-muted-foreground">
                        Cost Savings
                ...
                <div className="group relative">
                  <div className="h-full relative bg-gradient-to-br from-card to-terracotta/5 border border-terracotta/20 rounded-2xl p-6 text-center space-y-4 hover:border-terracotta/40 hover:-translate-y-2 hover:shadow-2xl hover:shadow-terracotta/30 transition-all duration-300">
                    ...
                    <div className="space-y-1">
                      <div className="text-2xl font-bold text-primary group-hover:text-terracotta transition-colors duration-300">
                        5×
                      </div>
                      <div className="text-sm font-medium text-muted-foreground">
                        Faster Hiring
                ...
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 rounded-full border-2 border-background overflow-hidden">
                      <img
                        src="/workers/PestControl.png"
                        alt="ServiceAgent customer testimonial avatar showing professional headshot"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="w-8 h-8 rounded-full border-2 border-background overflow-hidden">
                      <img
                        src="/workers/Plumber.png"
                        alt="ServiceAgent satisfied client avatar demonstrating hiring success"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="w-8 h-8 rounded-full border-2 border-background overflow-hidden">
                      <img
                        src="/workers/ResidentialCleaning.png"
                        alt="ServiceAgent business owner testimonial photo for hiring platform"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  </div>
                  <span className="font-medium">
                    150+ companies hiring better
                  </span>
                </div>
              </div>
            </div>
                          ...
                          {showUnderline && (
                            <span
                              ...
                              style={{
                                width: '100%',
                                animation:
                                  'drawUnderline 1.2s ease-in-out forwards',
                              }}
                            ></span>
                          )}
                        </span>{' '}

          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-lg">
                AI-powered hiring platform that conducts interviews, scores
                candidates, and saves you hours of time so you can hire the best
                talent faster.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            >
              ...
              <nav className="space-y-3">
                <Link
                  to="/blog"
                  className="block text-muted-foreground hover:text-gold transition-all duration-200 hover:translate-x-1"
                >
                  Blog
                </Link>
                <a
            ...
            >
              ...
              <nav className="space-y-3">
                <Link
                  to="/privacy-policy"
                  className="block text-muted-foreground hover:text-teal transition-all duration-200 hover:translate-x-1"
                >
                  Privacy Policy
                </Link>
                <Link
                ...
                <Link
                  to="/cookie-policy"
                  className="block text-muted-foreground hover:text-primary transition-all duration-200 hover:translate-x-1"
                >
                  Cookie Policy
                </Link>
              </nav>

...
const Demo = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            See how our AI conducts interviews, scores candidates, and helps you
            hire the best talent in minutes instead of days.
          </p>
        </div>
        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 opacity-20 pointer-events-none -z-10">
              ...
              <div
                className="absolute top-16 right-16 w-6 h-6 bg-teal rounded-full animate-pulse"
                style={{ animationDelay: '1s' }}
              />
              <div
                className="absolute bottom-10 left-16 w-3 h-3 bg-terracotta rounded-full animate-pulse"
                style={{ animationDelay: '2s' }}
              />
            </div>
            ...
            <div
              className="relative bg-card border-2 border-primary/20 rounded-3xl shadow-3xl overflow-hidden hover:border-primary/40 hover:shadow-[0_25px_80px_-12px_rgba(0,0,0,0.25)] hover:-translate-y-2 transition-all duration-500"
              style={{
                paddingBottom: '54.270833333333336%',
                height: '0',
              }}
            >
              <iframe
      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Watch how candidates interact with our AI interviewer
          </p>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            See how candidates are scored and ranked instantly
          </p>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Learn how to review and make hiring decisions fast
          </p>
        </div>
      </div>
    </section>
